...
export default function About() {
  return (
    <div className="flex flex-col gap-12 py-12 md:py-20 animate-fade-in">
      ...
      <section className="flex flex-col gap-6 prose prose-lg prose-neutral prose-headings:font-medium prose-headings:tracking-tight prose-a:text-[var(--foreground)] prose-a:decoration-[var(--foreground)]/30 prose-a:underline-offset-4 hover:prose-a:decoration-[var(--foreground)] prose-strong:text-[var(--foreground)] max-w-none prose-p:leading-relaxed">
        <Image src="/avatar.svg" alt="Faiaz Azmain" width={150} height={150} className="shrink-0 mb-8" priority />
